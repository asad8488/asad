...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mASAD Khan

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801926328818

\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mASAD THE BOT Tchannel
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/c/ASADTechnologychannel")

		exit()

	else:

		os.system("https://youtube.com/c/ASADTechnologychannel")
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [ASAD KHAN] %s|%s        '%(b,idf,pw))
